...
public:
    ...
    bool insert(ofstream& er,string name, string type)
    {
        ...
        if (currentScope)
        {
            ...
            else
            {
                ...
                er << "\t" << name << " already exists in the current ScopeTable"  << endl;
                return false;
            }
        }
        return false;
    ...
    void printCurrentScopeTable(ofstream& er, int lineNo)
    {
        ScopeTable *currentScope = getCurrentScope();
        if (currentScope)
        {
